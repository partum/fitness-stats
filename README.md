...
[] implement graph
-- [] scatter plot
-- [] use Average_BPM and Calories_Burned as initial values
-- [] only include Weight (kg),Height (m),Max_BPM,Avg_BPM,Resting_BPM,Session_Duration (hours),Calories_Burned,Fat_Percentage,BMI
[] implement filters
